  ...
  return (
   <Container className='my-3 px-6' id='about' style={{backgroundColor: 'white'}}>
     ...
     <Row>
       ...
       I'm a passionate, forward-thinking, and solution-oriented full-stack Software Engineer. I'm looking forward to growing my career by experiencing industry challenges. I've professional experiece of working with Nodejs, React etc. </p>
